...
INSERT INTO "new_Session" ("clarifyTurns", "exerciseCompleted", "exerciseStarted", "flowState", "id", "lessonId", "startedAt", "userId", "videoWatched") SELECT "clarifyTurns", "exerciseCompleted", "exerciseStarted", "flowState", "id", "lessonId", "startedAt", "userId", "videoWatched" FROM "Session";
DROP TABLE "Session";
