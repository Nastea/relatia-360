...
CREATE TABLE "new_Session" (
    ...
    "videoAsked" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Session" ("clarifyTurns", "exerciseCompleted", "exerciseStarted", "exerciseStep", "flowState", "id", "lessonId", "startedAt", "userId", "videoWatched") SELECT "clarifyTurns", "exerciseCompleted", "exerciseStarted", "exerciseStep", "flowState", "id", "lessonId", "startedAt", "userId", "videoWatched" FROM "Session";
DROP TABLE "Session";
